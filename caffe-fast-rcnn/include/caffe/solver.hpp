...
class Solver {
 ...
 protected:
  ...
  #define stack_cnt 10
  #define canv_loss_w 1150
  #define canv_loss_h 500
  #define canv_loss_plot_w 800
  #define canv_loss_plot_h 400
  #define canv_loss_plot_l 50
  #define canv_loss_plot_t 50
...
class SGDSolver : public Solver<Dtype> {
 ...
 protected:
  ...
  // Loss tracking for plateau
  bool plateau_init = false;
  int lr_updated_at;
  Dtype current_lr;
  Dtype current_window;
